...
#include <jni.h>
/* Header for class cn_lisa_smartventilator_utility_hardware_UartFrame */

#ifndef _Included_cn_lisa_smartventilator_utility_hardware_UartFrame
#define _Included_cn_lisa_smartventilator_utility_hardware_UartFrame
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     cn_lisa_smartventilator_utility_hardware_UartFrame
 * Method:    init
