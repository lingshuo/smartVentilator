...
//	}
	...
	public String toString() {
		return "ventilator:aldehyde:"+this.aldehyde+"/pm2.5:"+this.pm2_5+"/smog:"+this.smog
				+"/state_lamp:"+state_lamp+"/state_plasma:"+state_plasma+"/state_ultraviolet:"+state_ultraviolet
				+"/state_ventilator:"+state_ventilator+"/gear_ventilator:"+gear_ventilator;
	}
}
