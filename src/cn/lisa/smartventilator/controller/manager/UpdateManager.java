...
public class UpdateManager {
	...
	//存放更新APK文件的路径
	public static final String UPDATE_DOWNURL = "http://lingshuo.net.cn/smartVentilator.apk";
	//存放更新APK文件相应的版本说明路径
		...
		new Thread(){
			...
			public void run() {
				...
				try {
					...
					String verjson = NetHelper.getJsonStringGet("http://lingshuo.net.cn");
					Log.i("@@@@", verjson
							+ "**************************************************");
